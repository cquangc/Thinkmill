...
tab1, tab2, tab3 = st.tabs(["Load data", "Model", "Results"])
    ...
    if authentication_status == False or authentication_status == None:
        ...
        if uploaded_file1 == None:
            ...
            if uploaded_file1 is not None:
                ...
                st.write(
                    'Firstly, we show a simple file loading widget. To keep deployment simple, the example file has been shared with Thinkmill for loading from local machines. ')
                st.write(
                ...
                st.write(
                    ...
                    'Octant can readily adjust the allowable uplift/ downlift ranges.')
                st.write(
